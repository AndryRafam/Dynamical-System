...
A = np.pi*r**2
m = 0.2
# Air density (kg/m³), acceleration due to gravity (m/s²)
rho_air = 1.28
g = 9.81
# For convenience, define this constant.
k = 0.5*c*rho_air*A

# Initial speed and lauch angle (from the horizontal)
v0 = 50
phi0 = np.radians(45)

def diff_equation(t,u):
	x, xdot, z, zdot = u
...
soln = solve_ivp(diff_equation, (t0,tf), u0, dense_output=True,
...
plt.plot(x,z,color="black",lw=2)
plt.xlabel("x/m")
plt.ylabel("z/m")
plt.savefig("spherical_projectile.png")
plt.show()